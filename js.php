...
<html lang="ru">
    <head>
	    <div class="header">
			...
			<div class="header-item" id="title-item">
				<div class="nav-title"><h1>Использование js</h1></div>
			</div>
	...
	<body>
		<div class="advantages">
			<h2>Преимущества использования JS</h2>
			<ul class="js-ul">
				<?
				include ("js_advantages.php");
				?>
			</ul>
		</div>
		<div class="disadvantages">
			<h2>Недостатки использования JS</h2>
			<ul class="js-ul">
				<?
				include ("js_disadvantages.php");
				?>
			</ul>
		</div>
	</body>
